...
RSpec.describe UpvotesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all upvotes as @upvotes" do
      ...
      expect(assigns(:upvotes)).to eq([upvote])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested upvote as @upvote" do
      ...
      expect(assigns(:upvote)).to eq(upvote)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new upvote as @upvote" do
      ...
      expect(assigns(:upvote)).to be_a_new(Upvote)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created upvote as @upvote" do
        post :create, {:upvote => valid_attributes}, valid_session
        expect(assigns(:upvote)).to be_a(Upvote)
        expect(assigns(:upvote)).to be_persisted
      end

      it "redirects to the created upvote" do
        post :create, {:upvote => valid_attributes}, valid_session
        expect(response).to redirect_to(Upvote.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved upvote as @upvote" do
        post :create, {:upvote => invalid_attributes}, valid_session
        expect(assigns(:upvote)).to be_a_new(Upvote)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested upvote" do
        upvote = Upvote.create! valid_attributes
        put :update, {:id => upvote.to_param, :upvote => new_attributes}, valid_session
        upvote.reload
      ...
      it "redirects to the upvote" do
        upvote = Upvote.create! valid_attributes
        put :update, {:id => upvote.to_param, :upvote => valid_attributes}, valid_session
        expect(response).to redirect_to(upvote)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the upvote as @upvote" do
        upvote = Upvote.create! valid_attributes
        put :update, {:id => upvote.to_param, :upvote => invalid_attributes}, valid_session
        expect(assigns(:upvote)).to eq(upvote)
      end
